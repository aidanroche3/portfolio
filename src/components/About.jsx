...
function About() {
  return (
    <div
      id="about"
      className="w-full min-h-[90vh] bg-white-200 grid md:grid-cols-2 justify-center items-center px-20 pb-10 md:pb-32 md:gap-16"
    >
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-center max-w-[300px]">
          ...
          quisquam quia consequatur repudiandae saepe ad perspiciatis eius unde
          fugiat. Distinctio ipsam architecto tenetur totam, alias doloribus
          sunt.
        </p>
      </div>
      <Gallery />
